...
class Character(db.Model):
    ...
    # attendances = db.relationship("WCLAttendance", back_populates="character", cascade="all, delete-orphan") # Define if WCLAttendance model is used by app.py
    # performances = db.relationship("WCLPerformance", back_populates="character", cascade="all, delete-orphan") # Define if WCLPerformance model is used
