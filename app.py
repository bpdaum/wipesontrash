...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        # db.create_all() # Usually not needed here if migrations or release phase handles it
        print("DEBUG: app.py: Database tables checked/created if they didn't exist (if db.create_all() was run).", flush=True)
